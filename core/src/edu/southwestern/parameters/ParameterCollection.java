...
public class ParameterCollection<T> {
     ...
     *
     * @param label       Lookup value for parameter, both at commandline and in
     *                    simulation
     * @param value       Actual value of parameter
     * @param description Short text description of the parameter
     */
     ...
     *
     * @param label Lookup value of parameter
     ...
     *
     * @param label Lookup key for parameter
     ...
     * specified label
     *
     * @param label Lookup key to check for
     ...
     *
     * @param stream Where this output is directed. Typically a parameter file.
     */
