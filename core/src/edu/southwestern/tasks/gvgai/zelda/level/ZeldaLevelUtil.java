...
public class ZeldaLevelUtil {
    ...
    public static LinkedList<Node> uniformCostSearch(int[][] level, int startX, int startY) {
        ...
        PriorityQueue<Node> queue = new PriorityQueue<Node>(new Comparator<ZeldaLevelUtil.Node>() {
            //override compare method
            public int compare(ZeldaLevelUtil.Node i, ZeldaLevelUtil.Node j) {
     ...
     *
     * @param intLevel level to add enemies too
     */
