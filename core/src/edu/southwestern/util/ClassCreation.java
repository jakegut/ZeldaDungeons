...
public class ClassCreation {
     ...
     *
     * @param label name of the class to create object from
     ...
     *
     * @param className name of the class to create an object from
     ...
     *
     * @param constructor constructor from the class used to create desired objects
     ...
     *
     * @param constructor constructor from the class used to create desired objects
     * @param arguments   arguments used to construct the object
