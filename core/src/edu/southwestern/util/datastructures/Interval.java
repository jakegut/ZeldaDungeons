 ...
 *
 * @param <T> Comparable type that defines range bounds
 * @author Jacob Schrum
 */
public class Interval<T extends Comparable<T>> extends Pair<T, T> {
     ...
     *
     * @param start lower inclusive bound
     * @param end   upper inclusive bound
     */
     ...
     * General interval
     *
     * @param includeFirst Whether lower bound is inclusive
     * @param start        lower boundary
     * @param end          upper boundary
     * @param includeLast  Whether upper boundary is inclusive
     */
